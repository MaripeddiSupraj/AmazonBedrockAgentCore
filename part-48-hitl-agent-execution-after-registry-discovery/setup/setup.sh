...
python3.11 -m pip install --upgrade boto3 botocore requests
...
python3.11 -c "import botocore; print('Botocore Version:', botocore.__version__)"
python3.11 -c "import requests; print('Requests Version:', requests.__version__)"
